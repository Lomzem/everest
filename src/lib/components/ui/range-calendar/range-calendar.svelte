...
<RangeCalendarPrimitive.Root
	...
	class={cn(
		'p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(6)] bg-background group/calendar p-3 [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
		className,
	)}
	{locale}
	{monthFormat}
