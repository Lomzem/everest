	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					'bg-destructive text-destructive-foreground hover:bg-destructive/90 focus-visible:border-ring focus-visible:ring-ring/50',
...
{#if href}
	<!-- Callers resolve application paths before passing href to this shared primitive. -->
